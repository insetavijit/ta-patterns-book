...
| **Post-Exit Fib Engine (`pfib-engine`)** *(Core)* | [`Core/ta_patterns_book/level_touch/`](file:///home/avijit/workSpace/Code/ta-patterns-book/Core/ta_patterns_book/level_touch/) | `uv run pfib-engine --help` | Post-exit 15-candle Fibonacci runner excursion analyzer (0.0 to 3.0 grid). | `uv run pfib-engine` |
