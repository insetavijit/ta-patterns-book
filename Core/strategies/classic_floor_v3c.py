"""Adapter wrapping ClassicFloorModV3C to conform to StrategyProtocol.

ClassicFloorModV3C.generate_signals() returns a 3-tuple (entries, exits, trades_df).
...
from classic_floor_mod_v3C import ClassicFloorModV3C as _ClassicFloorModV3C


class ClassicFloorV3CStrategy:
    """StrategyProtocol-compatible wrapper for ClassicFloorModV3C.
    ...
    name: str = "classic_floor_mod_v3c"
    version: str = "3.3.0"

    def __init__(self) -> None:
        self._inner = _ClassicFloorModV3C()
    ...
    def generate_signals(
        ...
        """Delegate to ClassicFloorModV3C and cache the trades_df third element.
