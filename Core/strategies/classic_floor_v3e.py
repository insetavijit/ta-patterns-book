"""Adapter wrapping ClassicFloorModV3E to conform to StrategyProtocol.

ClassicFloorModV3E.generate_signals() returns a 3-tuple (entries, exits, trades_df).
...
from classic_floor_mod_v3E import ClassicFloorModV3E as _ClassicFloorModV3E


class ClassicFloorV3EStrategy:
    """StrategyProtocol-compatible wrapper for ClassicFloorModV3E.
    ...
    name: str = "classic_floor_mod_v3e"
    version: str = "3.5.0"

    def __init__(self) -> None:
        self._inner = _ClassicFloorModV3E()
    ...
    def generate_signals(
        ...
        """Delegate to ClassicFloorModV3E and cache the trades_df third element.
