...
from classic_floor_mod_v4c import ClassicFloorModV4C as _ClassicFloorModV4C


class ClassicFloorV4CStrategy:
    """StrategyProtocol-compatible wrapper for ClassicFloorModV4C.
    ...
    name: str = "classic_floor_mod_v4c"
    version: str = "4.3.0"

    def __init__(self) -> None:
        self._inner = _ClassicFloorModV4C()
