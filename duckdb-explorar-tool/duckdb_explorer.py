...
class ToolError(Exception):
    ...
    def __init__(self, message: str, exit_code: int, details: dict | None = None):
...
def make_envelope(command: str, success: bool, data: Any = None,
                   meta: dict | None = None, error: dict | None = None) -> dict:
...
def execute_with_timeout(conn: duckdb.DuckDBPyConnection, sql: str,
                          ...
                          timeout: float | None = None) -> duckdb.DuckDBPyConnection:
...
def run_sql(conn: duckdb.DuckDBPyConnection, sql: str, limit: int | None,
            offset: int | None = None, timeout: float | None = None) -> tuple[list[dict], int | None]:
...
def rows_to_dicts_capped(cursor: duckdb.DuckDBPyConnection, limit: int | None,
...
def estimated_row_count(conn: duckdb.DuckDBPyConnection, table: str, schema: str) -> int | None:
