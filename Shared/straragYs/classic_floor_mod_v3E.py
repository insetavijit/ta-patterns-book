...
class ClassicFloorModV3E:
    name = "classic_floor_mod_v3e"
    warmup_candles = 22
    ...
    def generate_signals(
        ...
        """
        ClassicFloorModV3E: Strategy entering on 3rd candle's open from signal,
            ...
            if waiting_for_entry and (current_target_bar is not None) and (i == current_target_bar):
                ...
                if checking_ugdrug:
                    ...
                    if df['entry_1'].iloc[i] == 'DR-UG-DR':
                        current_target_bar = i + 3  # Delay entry by 3 additional candles
                        continue
                    # Else green confirmation printed (e.g. DR-UG-UG) -> proceed to enter below
